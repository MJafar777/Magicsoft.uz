const ru = {
  ...
  Submit: "Отправить",
  contactFormSubtitle:
    "Отправляя этот запрос, вы соглашаетесь с нашей политикой конфиденциальности. Политика конфиденциальности соглашаетесь с нашей политикой конфиденциальности",
};
export default ru;
