export const HeaderData = {
  back: "Fintech, Banking, Financial Services & Insurance",
  title: "Fintech, Banking, Financial Services & Insurance",
  subTitle:
...
export const TechnologyData = {
  ...
  listOfSkil: [
    ...
    },
    {
      ...
      title: " Conversational AI in Banking",
      content:
    ...
    {
      id: 4,
      title: "Mobility enabled Cardless ATM",
      content:
...
export const SolutionData = {
  title: "Our Banking and Financial Software Solutions",
  listOfSolution: [
    {
      bgColor: "#000",
      title: "Custom Banking Software",
      content:
    ...
    {
      bgColor: "#000",
      title: "Peer-to-Peer (P2P) Lending and Crowdfunding Software",
      content:
    ...
    },
    {
      ...
      title: "Trading Platform Software Development",
      content:
    ...
    {
      bgColor: "#070E25",
      title: "Blockchain Solutions for Banking & Financial Services",
      content:
