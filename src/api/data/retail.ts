  ...
  listOfSkil: [
    {
      ...
      title: "Augmented Reality (AR) and O2O",
      content:
...
export const SolutionData = {
  title: "Our Retail and E-Commerce solutions",
  listOfSolution: [
    {
      bgColor: "#000",

      title: "E-Commerce Website Development Solutions",
      content:
    ...
    {
      bgColor: "#000",
      title: "Custom E-Commerce Shopping Cart",
      content:
    ...
    {
      bgColor: "#00170E",
      title: "Multi-Vendor Marketplace Software",
      content:
