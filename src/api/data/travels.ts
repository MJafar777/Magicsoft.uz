export const HeaderData = {
  back: "Travel, Logistics & Hospitality",
...
export const SolutionData = {
  title: "Our Hospitality and Travel Software Solutions",
  listOfSolution: [
    {
    ...
    {
      title: "Travel App Development Services",
      bgColor: "#000",
      content:
    ...
    {
      title: "Travel Web Development Services",
      bgColor: "#000",
      content:
